...
import kotlinx.android.synthetic.main.list_item_message_outgoing_text.view.*

class MessageOutgoingTextViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
